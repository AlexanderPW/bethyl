 ...
 */
	class Sreader implements SeekableIterator, Countable
	{
		 ...
		 */
		public function __construct($path, $OriginalFilename = false, $MimeType = false)
		{
			$Filepath = $path[0];
			...
			switch ($this -> Type)
			{
				...
				case self::TYPE_XLSX:
					...
					$this->ci->load->library('xlsx_importer', $path);
					$this -> Handle = new xlsx_importer($path);
					break;
				case self::TYPE_CSV:
